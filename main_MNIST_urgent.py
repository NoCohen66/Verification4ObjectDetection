...
list_info_time = []
images_exp = []
eps_list = np.linspace(0, 0.02,101)
...
for image_id in range(3):
    ...
    df.to_csv(f"urgent_new_results/MNIST_CROWN_brightness/{image_id}_iou_calculations.csv")
  

pd.DataFrame(list_info_time).to_csv("urgent_new_results/MNIST_CROWN_brightness/infos/times2.csv")
pd.DataFrame(images_exp).to_csv("urgent_new_results/MNIST_CROWN_brightness/infos/images.csv")
